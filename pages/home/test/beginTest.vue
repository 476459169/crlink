<template>
	<view class="">
		...
		<view class="flex_item">
			<image class="flex_img" src="../../../static/image/mine/studyImg.png" mode=""></image>
			<view class="flex_text">总  分：{{dataArr.totalScore}}分</view>
		</view>
		<view class="flex_item">
			<image class="flex_img" src="../../../static/image/mine/studyImg.png" mode=""></image>
			<view class="flex_text">合格分数：{{dataArr.passScore}}分</view>
		</view>
		<view class="flex_item">
			<image class="flex_img" src="../../../static/image/mine/studyImg.png" mode=""></image>
			<view class="flex_text">考试次数：{{dataArr.examNumbers}}次</view>
		</view>
	...
	export default {
		...
		methods: {
			...
			getData(examid) {
				...
				this.$api.post('exam!ajaxGetExamDescription.action', {
					loginKey: loginKey,
					examId: examid
				}).then(res => {
					if (res.res.status == 0) {
